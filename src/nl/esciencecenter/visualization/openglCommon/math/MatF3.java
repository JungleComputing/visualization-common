package nl.esciencecenter.visualization.openglCommon.math;
...
public class MatF3 extends MatrixF {
     ...
     */
    public MatF3(VecF3 v0, VecF3 v1, VecF3 v2, VecF3 v3) {
    	super(9);
    	buf.put(v0.asBuffer());
    	buf.put(v1.asBuffer());
    	buf.put(v2.asBuffer());
     ...
     */
    public MatF3(float m00, float m01, float m02, 
    ...
    public VecF3 mul(VecF3 v) {
    	return new VecF3(m[0 * 3 + 0]*v.v[0] + m[0 * 3 + 1]*v.v[1] + m[0 * 3 + 2]*v.v[2],
