...
public class HDRTexture2D extends Texture {
    ...
    public HDRTexture2D(int glMultitexUnit) {
    ...
    public HDRTexture2D copy(GL3 gl, int glMultitexUnit) {
        HDRTexture2D result = new HDRTexture2D(glMultitexUnit);
